<%@ Page Title="" Language="C#" MasterPageFile="~/usermaster.Master" AutoEventWireup="true" CodeBehind="userchangepassword.aspx.cs" Inherits="BookWorm.WebForm6" %>
    ...
    <div class="bookbanner">
      ...
      <div class="editsellerdata">
          ...
          <table class="sellertable">
               <tr>
                <td class="small">Old password:</td><td class="big"> <asp:TextBox ID="TextBox1" runat="server" CssClass="form-control"></asp:TextBox></td>

            </tr>
            <tr>
                <td class="small">New password:</td><td class="big">  <asp:TextBox ID="TextBox2" runat="server" CssClass="form-control"></asp:TextBox></td>

            </tr>
            <tr>
                <td class="small">Retype New password:</td><td class="big"><asp:TextBox ID="TextBox3" runat="server" CssClass="form-control"></asp:TextBox></td>
              ...
              <tr>
                  ...
                  <asp:Label ID="Label2" runat="server" Text="Label" ForeColor="#CC0000"></asp:Label>
