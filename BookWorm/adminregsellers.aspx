<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminregsellers.aspx.cs" Inherits="BookWorm.adminregsellers" %>
...
<body>
 ...
 <div class="admindata">
     <h4 style="text-decoration:underline;text-align:center;font-weight:900;">REGISTERED SELLERS</h4>
     <form runat="server">
             ...
             <div class="repeater">
                    <table>
                     <tr><td>Seller ID:</td><td>
                         <asp:Label ID="Label1" runat="server" Text='<%#Eval("sellerid") %>'></asp:Label></td></tr>
                     <tr><td>Name:</td><td>
                         <asp:Label ID="Label2" runat="server" Text='<%#Eval("sellername") %>'></asp:Label></td></tr>
                     <tr><td>Email:</td><td>
                         <asp:Label ID="Label3" runat="server" Text='<%#Eval("selleremail") %>'></asp:Label></td></tr>
                     <tr><td>Phone:</td><td>
                         <asp:Label ID="Label4" runat="server" Text='<%#Eval("sellerphone") %>'></asp:Label></td></tr>
                     <tr><td>Address:</td><td>
                         <asp:Label ID="Label5" runat="server" Text='<%#Eval("selleraddress") %>'></asp:Label></td></tr>
                        <tr><td>Location:</td><td>
                         <asp:Label ID="Label6" runat="server" Text='<%#Eval("sellerlocation") %>'></asp:Label></td></tr>
                     <tr><td>
