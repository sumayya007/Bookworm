<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="adminemail.aspx.cs" Inherits="BookWorm.adminemail" %>
          ...
          <table class="sellertable">
               ...
               <td>
                   <asp:DropDownList ID="DropDownList1" runat="server" CssClass="form-control" >
                       <asp:ListItem  Text="Select" Selected="True">(Select a category)</asp:ListItem>
                       <asp:ListItem>Subscribed users</asp:ListItem>
                       <asp:ListItem>Registered users</asp:ListItem>
                   </asp:DropDownList>
               </td>
           ...
           <tr>
              ...
              <tr>
                  ...
                  <asp:Label ID="Label2" runat="server" Text="Label" ForeColor="#CC0000" Visible="False"></asp:Label>
